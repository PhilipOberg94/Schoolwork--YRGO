class Husdjur:
    ...
    def __init__(self, namn, art, farg, laten, atit=0):
        self.namn = namn
        self.art = art
        self.farg = farg
        self.laten = laten
...
class Hund(Husdjur):
    def __init__(self, namn, farg, ras, atit=0):
        Husdjur.__init__(self, namn=namn, farg=farg, atit=atit, art="hund", laten="Voff")
        self.ras = ras
...
class Katt(Husdjur):
    def __init__(self, namn, farg, ras, atit=0):
        Husdjur.__init__(self, namn=namn, farg=farg, atit=atit, art="katt", laten="Mjau")
        self.ras = ras
